...
public class TicketMedio {
    ...
    public static void main(String[] args) {
        int ultimaVenda = 100;
	int penultimaVenda = 30;
	int antepenultimaVenda = 20;
	int mediaVendas = (ultimaVenda + penultimaVenda + antepenultimaVenda) / 3;

	System.out.println("Média das últimas vendas: " + mediaVendas);
    }
}